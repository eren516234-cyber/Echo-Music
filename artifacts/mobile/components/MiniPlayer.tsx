  ...
  return (
    ...
    >
      <View style={styles.bar}>
        <View style={[styles.barFill, { width: `${progress * 100}%` as any, backgroundColor: accent }]} />
      </View>
      <View style={styles.row}>
        ...
        <Pressable style={styles.btn} onPress={e => { e.stopPropagation(); Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); togglePlay(); }}>
          <Feather name={isPlaying ? "pause" : "play"} size={22} color="#fff" />
        </Pressable>
        <Pressable style={styles.btn} onPress={e => { e.stopPropagation(); Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); next(); }}>
...
const styles = StyleSheet.create({
  ...
  artist: { color: "#666", fontSize: 12, fontFamily: "Inter_400Regular" },
